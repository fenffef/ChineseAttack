...
def main(args):
    ...
    model = transformers.AutoModelForSequenceClassification.from_pretrained(args.model_name, num_labels=2, output_hidden_states=False, ignore_mismatched_sizes=True)
